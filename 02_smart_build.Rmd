...
Note that the `smart_ohio_raw.csv` and other data files we're developing in this Chapter are available on our [Data and Code website](https://github.com/THOMASELOVE/432-data)

```{r ingest_simpler, message = FALSE}
...
```{r create_income_imp, warning = FALSE}
set.seed(2020432001)
